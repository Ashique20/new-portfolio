const About = () => {
    return (
        <div className="bg-black p-2 relative ">
            ...
            <div className="text-white border-l-4 border-[#8581eb]">
                <h1 className="mr-[85%] font-bold text-2xl mt-20 mb-10">Welcome!</h1>
                <p className="text-4xl  ml-6  w-[50%]">I Am <span className="text-[#8581eb] font-bold">Mohammed Ashiqur Rahman</span></p>
                <p className="w-[50%]  mt-6 text-xl ml-6 "> I am A web developer  who is always ready to learn new features, update my own skill and do best with the knowledge i know.I have done more than about 12 projects and i am always ready to  <span className="mr-80">face learning new features.</span></p>
            </div>
            <div className=" p-2 m-2 w-96 ml-[62%] absolute top-[40%] border-l-4 border-[#8581eb]">
                <h1 className="text-2xl font-bold text-white">ForntEnd Skills</h1>
            ...
            <div className="w-96  ml-80 mt-60 text-white text-2xl border-l-4 border-[#8581eb] ">
                <h1 className="font-bold ">BackEnd Skills</h1>
                <ul className="ml-2">
